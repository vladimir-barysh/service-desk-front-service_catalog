...
import { HomePage, LoginPage, RequestsAllPage, RequestsInWorkPage, RequestsOnConfirmPage, RequestsSuccessPage, ServicesCatalogTreePage, ServicesCatalogItCatalogPage, ServicesCatalogItServicesPage, ServicesCatalogHistoryPage, DirectoryGroupsPage, DirectoryWorktypesPage } from './pages';
